...
import os, json, time, random, logging, subprocess, re, nltk, math
import  torch
...
import  sys
from    pubmed_section_classification import do_for_sents
...
resume_from                 = '/home/dpappas/sec_jpdrmm_2L_0p01_run_0/best_dev_checkpoint.pth.tar'
odir                        = '/home/dpappas/test_sec_jpdrmm_batch{}/'.format(b)
###########################################################

...
def print_the_results(prefix, all_bioasq_gold_data, all_bioasq_subm_data, all_bioasq_subm_data_known, data_for_revision):
    ...
    print('{} known F1 snippets: {}'.format(prefix, bioasq_snip_res['ΜF1 snippets']))
    ...
    logger.info('{} known F1 snippets: {}'.format(prefix, bioasq_snip_res['ΜF1 snippets']))
    ...
    print('{} F1 snippets: {}'.format(prefix, bioasq_snip_res['ΜF1 snippets']))
    ...
    logger.info('{} F1 snippets: {}'.format(prefix, bioasq_snip_res['ΜF1 snippets']))

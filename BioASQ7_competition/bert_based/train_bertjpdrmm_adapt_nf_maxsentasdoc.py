...
class Sent_Posit_Drmm_Modeler(nn.Module):
    ...
    def forward(self, doc1_sents_embeds, doc2_sents_embeds, doc1_oh_sim, doc2_oh_sim,
        ...
        return loss1, good_out, bad_out, gs_emits, bs_emits
...
print('frozen_or_unfrozen val: {} : {}'.format(sys.argv[1], frozen_or_unfrozen))
print('weight_loss_snip: {}'.format(weight_loss_snip))
print('weight_loss_doc val: {}'.format(weight_loss_doc))
#####################
if(frozen_or_unfrozen == 'unfrozen'):
...
#
odir = 'bioasq7_bertjpdrmadaptnf_maxsentasdoc_{}_{}_run_{}_WL_{}_{}/'.format('adapt' if(adapt) else 'toponly', frozen_or_unfrozen, run, weight_loss_snip, weight_loss_doc)
...
# CUDA_VISIBLE_DEVICES=1 python3.6 train_bertjpdrmm_adapt_nf_maxsentasdoc.py 1 1 0.1 1.0

...
odir                = os.path.join(resume_from, 'nolast_batch_{}'.format(batch_no))
...
# CUDA_VISIBLE_DEVICES=0 python3.6 extract_bert_jpdrmm_adapt_nf_nolast.py 1
...
"/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_adapt_frozen_run_0_WL_0.1/nolast_batch_1/v3 test_emit_bioasq.json" \
| grep "^MAP documents:\|^MAP snippets:"

java -Xmx10G -cp '/home/dpappas/bioasq_all/dist/my_bioasq_eval_2.jar' evaluation.EvaluatorTask1b -phaseA -e 5 \
"/home/dpappas/bioasq_all/bioasq7/data/test_batch_2/BioASQ-task7bPhaseB-testset2" \
"/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_adapt_frozen_run_0_WL_0.1/nolast_batch_2/v3 test_emit_bioasq.json" \
| grep "^MAP documents:\|^MAP snippets:"

java -Xmx10G -cp '/home/dpappas/bioasq_all/dist/my_bioasq_eval_2.jar' evaluation.EvaluatorTask1b -phaseA -e 5 \
"/home/dpappas/bioasq_all/bioasq7/data/test_batch_3/BioASQ-task7bPhaseB-testset3" \
"/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_adapt_frozen_run_0_WL_0.1/nolast_batch_3/v3 test_emit_bioasq.json" \
| grep "^MAP documents:\|^MAP snippets:"

java -Xmx10G -cp '/home/dpappas/bioasq_all/dist/my_bioasq_eval_2.jar' evaluation.EvaluatorTask1b -phaseA -e 5 \
"/home/dpappas/bioasq_all/bioasq7/data/test_batch_4/BioASQ-task7bPhaseB-testset4" \
"/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_adapt_frozen_run_0_WL_0.1/nolast_batch_4/v3 test_emit_bioasq.json" \
| grep "^MAP documents:\|^MAP snippets:"

java -Xmx10G -cp '/home/dpappas/bioasq_all/dist/my_bioasq_eval_2.jar' evaluation.EvaluatorTask1b -phaseA -e 5 \
"/home/dpappas/bioasq_all/bioasq7/data/test_batch_5/BioASQ-task7bPhaseB-testset5" \
"/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_adapt_frozen_run_0_WL_0.1/nolast_batch_5/v3 test_emit_bioasq.json" \
| grep "^MAP documents:\|^MAP snippets:"

...
resume_from         = '/media/dpappas/dpappas_data/models_out/bioasq7_bertjpdrmadaptnf_maxsentasdoc_adapt_frozen_run_0_WL_0.1_1.0/'
...
# CUDA_VISIBLE_DEVICES=0 python3.6 extract_bert_jpdrmm_adapt_nf_maxsentasdoc.py 1

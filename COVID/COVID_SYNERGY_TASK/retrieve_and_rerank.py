...
def retrieve_given_question(quest, n=100, exclude_pmids=None):
    docs                                = get_first_n(qtext= quest, n=n, exclude_pmids=exclude_pmids)

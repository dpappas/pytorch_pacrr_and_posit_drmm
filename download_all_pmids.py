            ...
            dato['Grants'].append(
                {
                    ...
                    'Agency':  get_children_with_tag(Grant, 'Agency')[0].text.strip()  if (
                            len(get_children_with_tag(Grant, 'Agency')) > 0
                            and
                            get_children_with_tag(Grant, 'Agency')[0].text is not None
                    ) else '',

...
def load_all_data(dataloc, w2v_bin_path, idf_pickle_path):
    ...
    with open(os.path.join(dataloc, 'rob04_bm25_docset_top100.test.s1.pkl'), 'rb') as f:
        test_docs = pickle.load(f)
    with open(os.path.join(dataloc, 'rob04_bm25_top100.dev.s1.pkl'), 'rb') as f:
        dev_data = pickle.load(f)
    with open(os.path.join(dataloc, 'rob04_bm25_docset_top100.dev.s1.pkl'), 'rb') as f:
        dev_docs = pickle.load(f)
    with open(os.path.join(dataloc, 'rob04_bm25_top100.train.s1.pkl'), 'rb') as f:
        train_data = pickle.load(f)
    with open(os.path.join(dataloc, 'rob04_bm25_docset_top100.train.s1.pkl'), 'rb') as f:
